/* ═══════════════════════════════════════════════════════════════════════
   ...
   📌 coupangUrl  = 쿠팡 파트너스 '링크 생성' 기능으로 발급한 URL만 유효
                    (link.coupang.com/a/... 형태). 상품 페이지 URL을 그대로 복사하면
                    수수료가 안 붙어요. 비워두면('') 이 제품은 구매 버튼이 아예 안 뜨고,
                    제품 정보(이름·가격·이유)만 보여요 — 쿠팡 검색으로 폴백하지 않아요
                    (가품 방지 원칙: link.coupang.com/a/... 발급 링크가 아니면 안 걸어요).
   📌 coupangSellerType = 판매자 확인 결과. 셋 중 하나만: 'rocket'(로켓배송) /
                    'brand_official'(브랜드 공식판매자) / 'brandstore'(쿠팡 브랜드스토어)
                    → coupangUrl을 채우기 전에 반드시 확인하고 여기 기록하세요.
...
window.KR_PRODUCTS = {
  ...
  '스킨1004 마다가스카르 센텔라 클렌징 폼':
    { price:12000, coupangUrl:'', coupangSellerType:'', coupangVerifiedAt:'', oyCuratorUrl:'',
  ...
  '라운드랩 1025 독도 토너':
    { price:14000, coupangUrl:'https://link.coupang.com/a/fMvNIWbe9Y', coupangSellerType:'brand_official', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
      ...
      tier:'commodity', texture:'light', sensitive_safe:true, emergency_safe:true },
  '라운드랩 자작나무 수분 토너':
    { price:16000, coupangUrl:'', coupangSellerType:'', coupangVerifiedAt:'', oyCuratorUrl:'',
  ...
  '라운드랩 자작나무 수분 선크림':
    { price:22000, coupangUrl:'', coupangSellerType:'', coupangVerifiedAt:'', oyCuratorUrl:'',
  ...
  '반코르 바쿠치올 세럼 5000ppm':
    { price:22220, coupangUrl:'', coupangSellerType:'', coupangVerifiedAt:'', oyCuratorUrl:'',
