...
window.KR_PRODUCTS = {
  ...
  '스킨1004 마다가스카르 센텔라 클렌징 폼':
    { price:12000, coupangUrl:'https://link.coupang.com/a/fS3bTUvcWa', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-08-02', oyCuratorUrl:'',
  ...
  '라운드랩 1025 독도 토너':
    { price:14000, coupangUrl:'https://link.coupang.com/a/fMvNIWbe9Y', coupangSearchUrl:'', coupangSellerType:'brand_official', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
      ...
      tier:'commodity', texture:'light', sensitive_safe:true, emergency_safe:true },
  '라운드랩 자작나무 수분 토너':
    { price:16000, coupangUrl:'https://link.coupang.com/a/fS2WqimOjs', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-08-02', oyCuratorUrl:'',
      verdict:'BEST_VALUE', priceReason:'수분·진정 위주 커머디티 처방. 더 비쌀 이유가 없어요.',
      tier:'commodity', texture:'light', sensitive_safe:true, emergency_safe:true },
  '스킨1004 마다가스카르 센텔라 토닝 토너':
    { price:18000, coupangUrl:'https://link.coupang.com/a/fS24tYKC9Q', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-08-02', oyCuratorUrl:'',
  ...
  '폴라초이스 2% BHA 리퀴드':
    { price:27600, coupangUrl:'https://link.coupang.com/a/fS2TWr5vzw', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-08-02', oyCuratorUrl:'',
  ...
  '코스알엑스 BHA 블랙헤드 파워 리퀴드':
    { price:18000, coupangUrl:'https://link.coupang.com/a/fSCyqziVuC', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
  ...
  '스킨1004 마다가스카르 센텔라 앰플':
    { price:18000, coupangUrl:'https://link.coupang.com/a/fS27HJGT3Q', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-08-02', oyCuratorUrl:'',
  ...
  '에스트라 아토베리어365 크림':
    { price:23900, coupangUrl:'https://link.coupang.com/a/fSCeEcfQeO', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
  ...
  '에스네이처 아쿠아 스쿠알란 수분크림':
    { price:22400, coupangUrl:'https://link.coupang.com/a/fSyc13gNvU', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
  ...
  '라운드랩 자작나무 수분 크림':
    { price:21000, coupangUrl:'https://link.coupang.com/a/fS2Zyhc1u0', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-08-02', oyCuratorUrl:'',
  ...
  /* ⚠️ 2026-07-29 신규 — hydrating 타입의 rich 대안(제형 다양성 공백 대응). HA 고함량 크림이라
     위 자작나무 수분크림보다 밀도가 있어요. rich 선호 번들번들형·겉번속건형·반반형에게 alt로 배정. */
  '토리든 다이브인 저분자 히알루론산 수딩 크림':
    { price:24000, coupangUrl:'https://link.coupang.com/a/fSyhjEZmGO', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
      verdict:'BEST_VALUE', priceReason:'히알루론산은 흔한 성분이라 이 가격이 적정해요.',
      tier:'commodity', texture:'rich', moisture_type:'hydrating', sensitive_safe:true },
  ...
  /* ── 자외선 차단 (Q10 마무리 finish별로 코드가 골라요) ──────────────
     ...
     finish=toneup → 셀퓨전씨 잡티 토닝 썬스크린(무기자차 톤업) ⚠️ 2026-07-29 product_db_슬롯매칭_작업방.md —
       메이크프렘 자리를 교체. 메이크프렘은 DB에서 제거함(문서 3번 지시)
     실외 3시간+ → 닥터지 그린 마일드 업 선스틱(덧바르기 팁) */
  '라운드랩 자작나무 수분 선크림':
    { price:22000, coupangUrl:'https://link.coupang.com/a/fSCcmgfBIG', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
  ...
  '닥터지 그린 마일드 업 선스틱':
    { price:16000, coupangUrl:'https://link.coupang.com/a/fS3dBL72WW', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-08-02', oyCuratorUrl:'',
  ...
  /* ⚠️ 2026-07-29 신규 — 피부과·레이저 시술 후에도 쓰는 극저자극 선크림으로 잘 알려진 제품.
     응급형(emergency_state) 전용 선크림으로 buildProtectSlot()에 우선 배정. */
  '셀퓨전씨 레이저 UV 썬스크린':
    { price:29000, coupangUrl:'https://link.coupang.com/a/fSyrsLX5Y4', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
      verdict:'WORTH_IT', priceReason:'시술 후에도 쓰는 저자극 처방이라 이 가격대가 정당해요.',
      tier:'premium', texture:'light', sunscreen_filter:'hybrid', whitecast:'none', sensitive_safe:true, emergency_safe:true },
  /* ⚠️ 2026-07-29 product_db_슬롯매칭_작업방.md — 메이크프렘 자리를 대체하는 톤업 선크림으로 확정.
     pickSunscreen()의 finish==='toneup' 분기에 배정됨. "잡티 토닝" 컨셉이라 브라이트닝 분기와도 결이 맞음. */
  '셀퓨전씨 잡티 토닝 썬스크린':
    { price:26000, coupangUrl:'https://link.coupang.com/a/fSDjftiZHM', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
      verdict:'WORTH_IT', priceReason:'톤업 + 잡티 케어 처방이라 이 가격대가 정당해요.',
      tier:'premium', texture:'light', sunscreen_filter:'inorganic', toneup:true, sensitive_safe:true },
  ...
  /* ⚠️ 2026-07-29 product_db_슬롯매칭_작업방.md — PIE 전용이 아니라 마무리 보습 hydrating 슬롯.
     번들번들형(balanced_oily) 중 트러블 동반 유저(trouble_concern)에게 토리든 HA 수딩크림 대신 배정됨. */
  '닥터지 레드 블레미쉬 클리어 수딩 크림':
    { price:24000, coupangUrl:'https://link.coupang.com/a/fSynwxKCKi', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
      verdict:'BEST_VALUE', priceReason:'센텔라 진정 크림은 흔한 처방이라 이 가격이면 합리적이에요.',
      tier:'commodity', texture:'rich', moisture_type:'hydrating', sensitive_safe:true, emergency_safe:true },

  /* ── 레티놀 본품 (바쿠치올 대체가 아니라 실제 레티놀) ──
     ⚠️ 2026-07-29 product_db_슬롯매칭_작업방.md — 목표는 "05 제품 추천의 4단계 주름 슬롯"에 배정.
     그런데 실제 코드(renderKit)엔 4단계는커녕 3단계 키트도 없음 — 지금 단계(1단계 장벽 또는
     2단계 아키타입별 키트) 하나만 버튼과 함께 렌더링되고, 3~4단계는 로드맵에 미리보기 문구
     (s3preview)로만 존재함. 이상형의 "레티놀(저농도)"도 04의 next-preview 텍스트일 뿐 실제 슬롯이
     아님. "새 UI 섹션 만들지 말라"는 문서 지시와 "4단계 슬롯에 넣으라"는 지시가 서로 충돌하는
     상태라 아직 안 씀 — 하이롱 확인 필요(04 next-preview 딥다이브로만 노출할지, 진짜 3~4단계
     키트 렌더링을 새로 만들지). */
  '아이오페 레티놀 슈퍼 바운스 세럼':
    { price:33000, coupangUrl:'https://link.coupang.com/a/fSB3yGEpsy', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
      verdict:'WORTH_IT', priceReason:'안정화·캡슐화 레티놀 처방이라 이 가격대가 정당해요.',
      tier:'premium', texture:'light', active_type:'retinol', sensitive_safe:false },
  '이니스프리 레티놀 시카 흔적 앰플':
    { price:28000, coupangUrl:'https://link.coupang.com/a/fSB7dzVqWO', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
      verdict:'WORTH_IT', priceReason:'레티놀+시카 안정화 처방이라 이 가격대가 정당해요.',
      tier:'premium', texture:'light', active_type:'retinol', sensitive_safe:false },
  ...
  '반코르 바쿠치올 세럼 5000ppm':
    { price:22220, coupangUrl:'https://link.coupang.com/a/fSCi5gFGa4', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-07-29', oyCuratorUrl:'',
  ...
  '구달 맑은 어성초 진정 수분 선크림':
    { price:19800, coupangUrl:'https://link.coupang.com/a/fS3adibnDU', coupangSearchUrl:'', coupangSellerType:'', coupangVerifiedAt:'2026-08-02', oyCuratorUrl:'',
